              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex flex-wrap gap-3">
                    <button 
                      onClick={() => {
                        navigator.clipboard.writeText('cissdoro@gmail.com');
                        const btn = document.getElementById('contact-btn-text');
                        if (btn) btn.innerText = 'Email Copié !';
                        setTimeout(() => {
                          if (btn) btn.innerText = "Contacter l'auteur";
                        }, 2000);
                        window.location.href = 'mailto:cissdoro@gmail.com';
                      }}
                      className="flex items-center gap-2 px-6 py-2.5 bg-amber-500 text-black rounded-full font-black text-xs uppercase tracking-widest hover:bg-white transition-all shadow-lg shadow-amber-500/20 active:scale-95"
                    >
                      <Mail className="w-4 h-4" /> <span id="contact-btn-text">Contacter l'auteur</span>
                    </button>
